...
void CShowDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHECK2, m_bShow);
}
...
BEGIN_MESSAGE_MAP(CShowDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_CHECK1, &CShowDlg::OnClickedCheck1)
	ON_BN_CLICKED(IDC_CHECK2, &CShowDlg::OnClickedCheck2)
END_MESSAGE_MAP()
